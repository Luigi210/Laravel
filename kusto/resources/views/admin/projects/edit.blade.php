...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактирование новости: {{$projects['title']}}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputEmail1"
                                        placeholder="Введите заголовок новости" value="{{$projects['title']}}" required>
                                </div>
                                

                                <div class="form-group">
                                    <textarea name="description" class="editor" style="resize:both">{{$projects['description']}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="feature_image">Изображение новости</label>
                                    <img src="{{$projects['image']}}" alt="" class="img-uploaded" style="display: block; width: 300px">
