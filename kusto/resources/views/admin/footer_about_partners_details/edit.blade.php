...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Изменить Детали</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{route('footer_about_partners_details.update', [ 'id' => $footerAboutPartnersDetail['id']])}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="">Название</label>
                                    <input type="text" name="title" class="form-control" id=""
                                        placeholder="Введите название" value="{{$footerAboutPartnersDetail['title']}}" required>
                                </div>

                                <div class="form-group">
                                    <label for="">Ссылка</label>
                                    <input type="text" name="link" class="form-control" id=""
                                        placeholder="Введите ссылку" value="{{$footerAboutPartnersDetail['link']}}" required>
                                </div>
