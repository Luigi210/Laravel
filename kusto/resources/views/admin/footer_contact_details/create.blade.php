            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{route('footer_contact_details.store')}}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="details" class="form-control" 
                                        placeholder="Введите детали" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_id" class="form-control" id="exampleInputEmail1"
                                        placeholder="Введите contact ID" value="{{$contacts['id']}}" readonly required>
